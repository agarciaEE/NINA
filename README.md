...
#> enough observations of spC in region A.
...
#>      - Modelling spA Environmental Niche...
#>      - Estimating spA niche response in region D...
#>      - Modelling spB Environmental Niche...
...
<img src="man/figures/README-ENmodels-1.png" width="100%" />
...
#>      - Modelling sp1 Environmental Niche...
#> Warning in EN_model_(env, occ, res = res, nstart = nstart, k.max = k.max, : Not
#> enough observations of sp1 in region C.
#>      - Modelling sp2 Environmental Niche...
...
#>      - Modelling sp5 Environmental Niche...
#>      - Estimating sp5 niche response in region D...
#>  - Carrying out species EN models in region E...
#>      - Modelling sp1 Environmental Niche...
#>      - Estimating sp1 niche response in region E...
#>      - Modelling sp2 Environmental Niche...
#>      - Estimating sp2 niche response in region E...
#>      - Modelling sp3 Environmental Niche...
...
You can summarize the output by using function or :
...
You can also plot a summary of the output model using function:

    #> Ploting only the first four species maps of a total of 5TRUE

<img src="man/figures/README-plot-1.png" width="100%" />

Models can be evaluated using NINA’s function and visualize it by
plotting the output.
...
#> Warning in sum(new("RasterStack", filename = "", layers =
#> list(new("RasterLayer", : Nothing to summarize if you provide a single
